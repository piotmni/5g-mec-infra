...
build {
  ...
  provisioner "ansible-local" {
    only = ["openstack.monitoring"]

    playbook_dir  = "../ansible/"
    playbook_file = "../ansible/playbooks/packer_monitoring.yml"
...
#    extra_arguments = [
#      "--vault-password-file=.vagrant-vault",
#      "--extra-vars",
#      "ovh_region=\"${var.OS_REGION_NAME}\""
#    ]
  }

  provisioner "ansible-local" {
    only = ["openstack.nomad-server"]

    playbook_dir  = "../../ansible/"
    playbook_file = "..././ansible/playbooks/packer_nomad_server.yml"
  ...
  provisioner "ansible-local" {
    ...
    playbook_dir  = "../../ansible/"
    playbook_file = "../../ansible/playbooks/packer_lb.yml"
